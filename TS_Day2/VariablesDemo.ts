// Variable: container which can hold/store same data

//var, let , const  --> Keywords

//In type scrip and java script specifying the data type is optional

//Syntax: keywoard variableName : data type(optional)=value
...
/*
    ...
    3) Re-declaration
    4) Re-initialization/Re-assingnment
    5)Hoisting
*/
...
/* function scopeDiff(){
    ...
    console.log(num2); //canot access -block
...
//Example 1: var allowed the re-declaration
/* var city="New York";
